	...
	<body>
		...
		<div id="list-player" class="content scaffold-list" role="main">
			...
			<thead>
					...
					<g:sortableColumn property="id" title="${message(code: 'player.seed.label', default: 'Player Id')}" />
					
						<g:sortableColumn property="seed" title="${message(code: 'player.seed.label', default: 'Seed')}" />
					
						<g:sortableColumn property="playerName" title="${message(code: 'player.playerName.label', default: 'Player Name')}" />
				...
				<g:each in="${playerInstanceList}" status="i" var="playerInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: playerInstance, field: "seed")}</td>
					
						<td>${fieldValue(bean: playerInstance, field: "playerName")}</td>
