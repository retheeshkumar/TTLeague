...
//grails.plugin.springsecurity.logout.filterProcessesUrl = '/login/index'
//grails.plugin.springsecurity.logout.afterLogoutUrl='/login/index'
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.fms.auth.User'
...
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
	...
	'/role/**':       ['ROLE_ADMIN'],
	'/userRole/**':   ['ROLE_ADMIN'],
	'/dashboard/**':   ['ROLE_ADMIN','ROLE_USER','ROLE_GUEST'],
...
/*grails.plugin.springsecurity.useSecurityEventListener = true
 grails.plugin.springsecurity.onInteractiveAuthenticationSuccessEvent = { e, appCtx ->
		 ...
		 com.compumail.auth.User.withTransaction { com.compumail.auth.User.findByUsername(e.authentication.name).lastLogin = new Date() }
